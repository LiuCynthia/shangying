...
public class InvoicetypeControllerBean extends AbstractInvoicetypeControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.custom.financialinvoice.app.InvoicetypeControllerBean");
}